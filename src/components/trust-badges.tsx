...
const badges = [
  ...
  },
  {
    year: "2025",
    label: "Trusted",
    description: "Discreet delivery and private consultations trusted by patients across Nigeria",
  },
];
...
function LaurelLeft() {
  return (
    <svg width="28" height="36" viewBox="0 0 28 36" fill="none" aria-hidden="true">
      <path
        d="M14 34C14 34 2 28 2 18C2 8 14 2 14 2"
        stroke="#D4A843"
        strokeWidth="1.5"
        fill="none"
      />
      <path
        d="M14 30C14 30 6 25 6 18C6 11 14 6 14 6"
        stroke="#D4A843"
        strokeWidth="1.2"
        fill="none"
      />
