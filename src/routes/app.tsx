...
export const Route = createFileRoute("/app")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "The PocketPill mobile app is currently being built. Join the waitlist today.",
      },
    ],
  }),
});
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#123d2d] text-white">
      ...
      <header className="absolute inset-x-0 top-0 z-50 flex items-center justify-between px-6 py-6 lg:px-12">
        ...
        <Link
          to="/"
          className="text-sm font-medium text-white/80 hover:text-white flex items-center transition-colors"
        >
      ...
      <main className="flex-1 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container px-6 py-24 relative z-10 mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/70 mb-12 max-w-2xl mx-auto leading-relaxed text-balance">
            Our beautifully designed mobile app is currently being built. We're working hard to
            bring the full PocketPill pharmacy and telehealth experience directly to your
            smartphone.
          </p>
            ...
            {submitted ? (
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 animate-in fade-in zoom-in duration-500">
                ...
                <p className="text-white/70">
                  Thank you for joining. We'll notify you as soon as the PocketPill app is ready for
                  download.
                </p>
              </div>
            ) : (
              <form
                ...
                className="flex flex-col gap-4 sm:flex-row animate-in fade-in slide-in-from-bottom-4 duration-700"
              >
                <Input
                  type="email"
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="h-14 rounded-xl bg-white text-[#123d2d] hover:bg-white/90 font-semibold px-8 whitespace-nowrap transition-transform hover:scale-105 active:scale-95"
                >
