            ...
            <div className="space-y-8">
              <div className="text-center mb-10">
                ...
                <p className="text-muted-foreground">
                  Fill in the details below. We'll verify the prescription and text you back.
                </p>
              </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-4">
                    <label className="text-sm font-medium block">
                      Photo / file of current prescription *
                    </label>
                    <input
                      type="file"
                      ref={fileInputRef}
                    ...
                    {files.length === 0 ? (
                      ...
                      <div className="flex flex-wrap gap-4">
                        {files.map((file, idx) => (
                          <div
                            key={idx}
                            className="relative group rounded-lg overflow-hidden border border-border/50 bg-white h-24 w-24 flex items-center justify-center"
                          >
                            {file.type.startsWith("image/") ? (
                              ...
                              <span className="text-xs text-center p-2 truncate w-full">
                                {file.name}
                              </span>
                            )}
                            <button
