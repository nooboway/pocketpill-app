          ...
          <div className="max-w-2xl mx-auto bg-white rounded-3xl p-10 lg:p-16 shadow-card border border-border/40 text-center space-y-8 animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                A pharmacist will text you on WhatsApp with availability, timeline, and cost. Keep
                your phone close. You do not need to chase us.
              </p>
            </div>
            <div className="pt-8 mt-8 border-t border-border/50">
              <p className="text-sm text-muted-foreground">
                ...
                <Link
                  to="/lineage"
                  className="text-[#2b8a62] hover:underline font-bold ml-2 inline-flex items-center"
                >
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-card border border-border/40">
              <form onSubmit={handleSubmit} className="space-y-8">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Type the name or upload a photo. One of the two is enough.
                  </p>
                </div>
                  ...
                  {files.length === 0 ? (
                    ...
                    <div className="flex flex-wrap gap-4 bg-[#f9faf7] p-4 rounded-xl border border-border/40">
                      {files.map((file, idx) => (
                        <div
                          key={idx}
                          className="relative group rounded-lg overflow-hidden border border-border/50 bg-white h-20 w-20 flex items-center justify-center shadow-sm"
                        >
                          {file.type.startsWith("image/") ? (
                            ...
                            <span className="text-xs text-center p-1 truncate w-full">
                              {file.name}
                            </span>
                          )}
                          <button
                  ...
                  <div className="animate-in slide-in-from-top-4 fade-in duration-300 space-y-6 pt-6 border-t border-border/50">
                    ...
                    <div className="pt-2">
                      ...
                      <p className="text-xs text-center text-muted-foreground mt-4">
                        By submitting, you agree to a pharmacist contacting you via WhatsApp. No
                        payment is required yet.
                      </p>
                    </div>
                  </div>
                )}
