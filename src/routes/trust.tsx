...
const pillars = [
  {
    ...
    description:
      "Every pharmacist on our platform is fully licensed and registered with the Pharmacy Council of Nigeria (PCN). When you speak to a PocketPill pharmacist, you are consulting a verified clinical expert.",
  },
  {
    icon: ShieldCheck,
    title: "Genuine Medications",
    description:
      "We source medications exclusively from trusted, vetted manufacturers and major licensed distributors in Nigeria. This strict supply chain ensures that every medication delivered is 100% authentic and uncompromised.",
  },
  {
    icon: LockKeyhole,
    title: "Data Privacy & Security",
    description:
      "Your health information and orders stay strictly private. All records and messages are encrypted and stored in secure infrastructure compliant with the Nigeria Data Protection Act (NDPA) 2023.",
  },
  {
    icon: FileText,
    title: "Regulatory Compliance",
    description:
      "PocketPill operates in strict adherence to Nigerian healthcare and data protection regulations. We are registered with the Nigeria Data Protection Commission (NDPC).",
  },
];
              ...
              <div className="grid md:grid-cols-[1fr_auto]">
                <div className="p-8 sm:p-12">
                  ...
                  <p className="mt-4 max-w-lg leading-relaxed text-muted-foreground">
                    PocketPill is officially certified by the Nigeria Data Protection Commission
                    (NDPC). We regularly audit our data processing practices to ensure full
                    compliance with the Nigeria Data Protection Act (NDPA) 2023 and the General
                    Application and Implementation Directive (GAID).
                  </p>
                  <ul className="mt-6 space-y-3">
                    {[
                      "End-to-end encryption for patient data",
                      "Strict access controls for clinical staff",
