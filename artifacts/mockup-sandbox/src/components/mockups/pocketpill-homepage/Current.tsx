    ...
    <div style={{ minHeight: "100vh", background: "#fffefa", color: "#101d19" }}>
      <header
        style={{
          ...
          padding: "0 5%",
          borderBottom: "1px solid #e7e8e1",
        }}
      >
        <strong style={{ fontFamily: "Manrope", fontSize: 22, letterSpacing: "-.06em" }}>
          PocketPill
        </strong>
      ...
      <main>
        <section
          style={{
            ...
            minHeight: 650,
            padding: "72px 5%",
            background: "linear-gradient(125deg, #fffefa 0%, #fffefa 58%, #fdf2e8 58%)",
          }}
        >
          <div>
            <span
            ...
            >
              <span style={{ color: "#ed5b15" }}>Private men's health care</span> for stronger,
              longer, calmer sex.
            </h1>
            <p
              style={{
            ...
            >
              Pharmacist-led consultations for erectile dysfunction and premature ejaculation — on
              WhatsApp, for men across West Africa and the diaspora.
            </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.1fr .9fr", gap: 14, height: 470 }}>
            <img
              src={image("hero.jpg")}
              alt="Man starting a private consultation"
            ...
            <div style={{ display: "grid", gap: 14, gridTemplateRows: "1fr 1fr" }}>
              <img
                ...
                alt="Pharmacist reviewing answers"
                style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: 28 }}
              />
              <img
        ...
        >
          {[
            [
              "Discreet by design",
              "One private thread. No waiting room, front desk, or awkward handover.",
            ],
            [
              "Medication expertise",
              "Clear explanations of treatment options, safety, and interactions.",
            ],
            ...
            <article key={title} style={{ padding: 22, borderRadius: 22, background: "white" }}>
              <h2
                style={{ margin: 0, fontFamily: "Manrope", fontSize: 20, letterSpacing: "-.04em" }}
              >
                {title}
              </h2>
